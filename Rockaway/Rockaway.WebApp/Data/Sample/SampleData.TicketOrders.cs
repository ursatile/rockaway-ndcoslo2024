...
public static partial class SampleData {
	...
	public static class TicketOrders {
		...
		public static TicketOrder Order001 =
			Shows.Coda_Barracuda_20240817.CreateTestOrder("Ace Frehley", "ace@example.com");

		public static TicketOrder Order002 =
			Shows.Coda_NewCrossInn_20240820.CreateTestOrder("Brian Johnson", "brian@example.com");

		public static TicketOrder Order003 =
			Shows.Coda_PubAnchor_20240823.CreateTestOrder("Joey Tempest", "joey.tempest@example.com");
